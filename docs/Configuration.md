...
values (nextval('ssl_mobile_app_version_seq'), 'my-testing-app', 'IOS', '3.3.0', '3.1.0', null, 'my-testing-app.message-key');
```
...
```sql
insert into ssl_mobile_app_version(id, application_name, platform, suggested_version, required_version, major_os_version, message_key)
values (nextval('ssl_mobile_app_version_seq'), 'my-testing-app', 'IOS', '2.7.0', '1.9.0', 11, 'my-testing-app.message-key');
```
