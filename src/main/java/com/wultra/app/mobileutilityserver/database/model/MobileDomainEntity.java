...
public class MobileDomainEntity {
    ...
    @Id
    @Column(name = "id")
    @SequenceGenerator(name = "ssl_mobile_domain", sequenceName = "ssl_mobile_domain_seq", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ssl_mobile_domain")
    private Long id;
