...
values (nextval('ssl_mobile_app_version_seq'), 'suggested-app', 'APPLE', '3.3.0', null, null, 'suggested-app.performance'),
       ...
       (nextval('ssl_mobile_app_version_seq'), 'required-app', 'APPLE', null, '3.3.0', null, 'required-app.internet-banking'),
       (nextval('ssl_mobile_app_version_seq'), 'required-app', 'ANDROID', null, '3.3.0', null, null),
       (nextval('ssl_mobile_app_version_seq'), 'required-app', 'APPLE', null, '3.2.0', 11, null),
       (nextval('ssl_mobile_app_version_seq'), 'required-app', 'ANDROID', null, '2.9.0', 29, null),
       (nextval('ssl_mobile_app_version_seq'), 'suggested-and-required-app', 'APPLE', '3.0.0', '2.0.0', null, null);
