...
values (nextval('ssl_mobile_app_version_seq'), 1, 'IOS', '3.3.0', null, null, 'suggested-app.performance'),
       (nextval('ssl_mobile_app_version_seq'), 1, 'ANDROID', '3.3.0', null, null, 'suggested-app.performance'),
       (nextval('ssl_mobile_app_version_seq'), 1, 'IOS', '3.1.0', null, 11, null),
       (nextval('ssl_mobile_app_version_seq'), 1, 'ANDROID', '3.1.0', null, 29, null),
       (nextval('ssl_mobile_app_version_seq'), 2, 'IOS', null, '3.3.0', null, 'required-app.internet-banking'),
